...
| [qa-process-metrics-schema.md](qa-process-metrics-schema.md) | `qa_process_metrics` Sheet schema, the Baseline 3 / Core 6 / Extended tier discipline, the sprint-versus-month period model, and source priority — read this every time |
