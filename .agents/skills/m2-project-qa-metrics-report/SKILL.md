...
5. For DOCX/XLSX sources, first check whether an extracted copy already exists under `G:\My Drive\QA_Management\80_Exports\source_extracts\YYYY-MM-DD\<Project>\...`.
